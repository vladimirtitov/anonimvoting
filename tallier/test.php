...
$data = array('data' => '{"name":"Vova", "bulletin":5, "max_vote":"xf5", "public_key_vote":"sdsafadfsdsf", "date_start":"2016-12-12 21:00:00", "date_end":"2016-12-12 21:00:00"}');


$url1 = 'http://localhost:8888/anonimvoting/tallier/authorizeKey';
$data1 = array('data' => '{"voting_id":3, "voter_public_key":"ABCD3423423EFGHEFGHI", "encoded_voter_public_key":"3r2r3r23r23"}');


$url2 = 'http://localhost:8888/anonimvoting/tallier/sendBulletin';
...
$url3 = 'http://localhost:8888/anonimvoting/tallier/sendSecretKey';
...
$url4 = 'http://localhost:8888/anonimvoting/tallier/getVotingData';
...
$result = file_get_contents($url4, false, $context);
